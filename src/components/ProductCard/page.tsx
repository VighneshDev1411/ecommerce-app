...
const ProductCard: React.FC<ProductProps> = ({
  ...
  return (
    <div className="w-[280px] h-[400px] bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 flex flex-col">
      {/* Image Container */}
      ...
      <div className="flex-1 p-4 flex flex-col justify-between">
        <div>
          {/* Product Name */}
          <h5 className="text-base font-semibold text-gray-900 dark:text-white line-clamp-2 mb-2">
            {name}
          </h5>
